...
<div id="content">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <ul class="nav nav-tabs" id="language">
                ...
                <li><a href="#language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                  ...
                  <tbody>
                    ...
                    <tr id="attribute-row<?php echo $attribute_row; ?>">
                      ...
                      <td class="text-left"><?php foreach ($languages as $language) { ?>
                        <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
  ...
  <?php
	$http_server_value = HTTP_SERVER;
	if (isset($_SERVER["HTTPS"]) && $_SERVER["HTTPS"] == "on" || (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https'))
		$http_server_value = HTTPS_SERVER;	
  ?>
  <script type="text/javascript">
	var ajaxurl = 'index.php?route=catalog/tshirtecommerce/ajax&token=<?php echo $token; ?>';
	var tshirtURL = '<?php echo str_replace('/admin/', '', $http_server_value); ?>/tshirtecommerce/';
  </script>
	<script src="<?php echo str_replace('/admin/', '', $http_server_value) . '/tshirtecommerce/assets/js/app.js'; ?>" type="text/javascript"></script>  
	<link href="<?php echo str_replace('/admin/', '', $http_server_value) . '/tshirtecommerce/assets/css/opencart.css'; ?>" type="text/css" rel="stylesheet" />
  <!-- END:: add css and js -->
...
function addAttribute() {
	...
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span><textarea name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></div>';
    <?php } ?>
	html += '  </td>';
