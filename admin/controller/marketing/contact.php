					...
					case 'newsletter':
						$customer_data = array(
							...
							'limit'             => 10
                                                ...
                                                //select emails from newsletter table
                                                $sql = "SELECT news_email AS email FROM " . DB_PREFIX . "newsletter";
                                                $query = $this->db->query($sql);
                                                $emails_newsletter = $query->rows;
                                                foreach ($emails_newsletter AS $em) {
                                                    array_push($emailArray,$em['email']);
                                                }
