...
<head>
    ...
    <meta content="<?php echo setValue($settings, 'meta_description', 'Custom product'); ?>" name="description" />
	<meta content="<?php echo setValue($settings, 'meta_keywords', 'Custom product'); ?>" name="keywords" />
    <title><?php echo setValue($settings, 'site_name', 'Custom product'); ?></title>
	
	<meta property="og:url" content="<?php echo $url; ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="<?php echo setValue($settings, 'site_name', 'Custom product'); ?>" />
    <meta property="og:description" content="<?php echo setValue($settings, 'meta_description', 'Custom product'); ?>" />
