                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-inner">              
                                    <ul class="list-unstyled">              
                                        <li><a href="index.php?route=information/information&information_id=7"><?php echo $text_mobile; ?></a></li>
                                        <li><a href="index.php?route=information/information&information_id=8"><?php echo $text_shirt; ?></a></li>
                                        <li><a href="index.php?route=information/information&information_id=9"><?php echo $text_giveaways; ?></a></li>
                                    </ul>           
                                </div>
                            </div>
                        </li> 
