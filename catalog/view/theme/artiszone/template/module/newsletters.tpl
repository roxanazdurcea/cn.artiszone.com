    ...
    <div style="width: 100%; background-image: url('http://artiszone.com/image/catalog/artiszone-images/homepage-banners/background-newsletter.png');">
        <div class="container">
            <div class="row" style="margin:2%;">
                <h3 class="col-sm-5 text-center text-right" style="color: #fff;">Sign up for artisJet updates</h3>
                <form action="" method="post">
                    <div class="form-group required">
                        <!--<label class="col-sm-2 control-label" for="input-firstname">Email:</label>-->
                        <div class="col-sm-5 col-xs-8" style=" padding-right: 0px;">
                            <input style="border-radius: 0px; height: 45px; background: rgba(255, 255, 255, .5); border: 1px solid #000;" type="email" name="txtemail" id="txtemail" value="" placeholder="Enter your email here" class="form-control"  /> 
                        </div>
                    </div>
                    <div class="form-group required">
                        <!--<label class="col-sm-2 control-label" for="input-firstname">Email:</label>-->
                        <div class="col-sm-2 col-xs-4" style=" padding-left: 0px;">
                            <button style="background: rgba(255, 255, 255, .5); border: 1px solid #000; color: #000; font-weight: 700; height: 45px;     width: 100%;" type="submit" class="btn btn-default btn-lg" onclick="return subscribe();">JOIN</i></button>  
                        </div>
                    </div>
                </form>
            </div>
